...
int main(int, char**)
{
    ...
    while (running) {
        ...
        player.update(input.move_axis, aim_world_x, aim_world_y, input.mouse_in_view, dt);
        ...
        renderer2d.render_scene(assets, player, zombies.data(), static_cast<int>(zombies.size()), camera);
