...
- 管理基础资源、高级资源、武器、配件、药品、燃料、食物和末世硬通货。
- 支持建造、制作、交易、探索消耗和 NPC 消耗。
- 区分基地仓库资源、角色背包物品和无线电交易货币。
...
- `ItemDefinition`：物品定义。
- `CraftRecipe`：制作配方。
- `CurrencyStack`：末世硬通货数量。
- `ResourceCategory`：资源分类。

设计原则：

- 资源种类要少而有用，避免玩家记不住用途。
- 每种核心资源至少服务两个系统，例如建造、交易、探索、治疗或防守。
- 背包显示随身物品，基地仓库显示建筑资源和大宗资源。
- 玩家回到基地后，建筑资源自动存入仓库，减少整理负担。
- 货币必须是末世里仍有实际价值或稳定共识的东西，不能用旧世界钞票。
...
- 木材：路障、床、耕地、基础设施、修门。
- 金属：铁门、炮塔、发电机、武器台、防御设施。
- 布料：绷带、床铺、背包、过滤材料、保暖物。
- 玻璃：窗户、温室、灯具、太阳能板。

工业资源：

- 通用零件：维修和基础制作。
- 机械零件：发电机、炮塔、工作台、高级设施。
- 电子元件：无线电、灯、炮塔控制、电池、太阳能。
- 塑料零件：水桶、管线、药品包装、简易设备。
- 化学品：化学肥、药品、燃烧瓶、特殊弹药。
...
旧世界纸币不作为通用货币。可以保留为可搜刮废品、剧情物品或点火材料，但不应承担交易价值。

推荐硬通货候选：

1. 弹壳。
   - 优点：世界观合理，数量多，和枪械社会强相关。
   - 用途：可复装弹药，也可按重量和金属价值交易。
   - 风味：末世里“能换命的东西”天然有信用。

2. 瓶盖或拉环。
   - 优点：直觉上接近 Fallout 式流通货币，辨识度强。
   - 缺点：容易显得致敬过明显，需要本作自己的解释。
   - 可解释为黑市无线电网络用统一防伪压印瓶盖记账。

3. 电池芯。
   - 优点：和电力系统强绑定，末世中真实有价值。
   - 缺点：如果既是货币又是材料，玩家可能舍不得交易。
   - 适合高级交易，不适合日常小额货币。
...
- 与固定商人或幸存者营地交易、完成委托、救援 NPC 后获得。
- 信用等级越高，可购买的枪械、图纸、情报越好。
- 无线电信用不是实体物品，不占背包重量。
- 它适合解释“远程下单”和“无人机/投递点交货”。

资源 UI 建议：

- 顶栏只显示少数核心资源：弹壳、无线电信用、药品/医疗包、当前电力或汽油。
- 背包右侧显示基地仓库资源：木材、金属、布料、电子元件、汽油、零件、玻璃、食物、水、药品。
- 建造模式只显示当前建筑需要的相关资源，避免资源列表过长。
- 探索结算界面按分类显示带回资源，并自动存入仓库。
...
首版先不要加入太多子弹口径、复杂化学品、电线、玻璃和多种肥料。等建造、电力、探索循环成立后，再把资源拆细。
